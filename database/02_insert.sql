...
-- 6. TRECHOS
-- ------------------------------------------------------------
INSERT INTO Trecho (tipo_trecho, distancia_km, codigo_IATA_origem, codigo_IATA_destino, num_voo, status_sazonalidade, via_aerea_regulamentada) VALUES
('Direto',       2368.00, 'GRU', 'FOR', 'LA3045', 'Normal',      TRUE),
('Direto',       2368.00, 'FOR', 'GRU', 'LA3210', 'Normal',      TRUE),
('Direto',       2691.00, 'GRU', 'MAO', 'LA3320', 'Normal',      TRUE),
('Direto',       9461.00, 'GRU', 'MIA', 'LA8010', 'Normal',      TRUE),
('Direto',       9218.00, 'GRU', 'CDG', 'LA8020', 'Conturbado',  TRUE),
('Com Escala',   7340.00, 'GRU', 'EZE', 'LA8030', 'Normal',      TRUE),
('Direto',       1655.00, 'GRU', 'FOR', 'LA3500', 'Normal',      TRUE),
('Direto',       1290.00, 'REC', 'GRU', 'LA3501', 'Normal',      TRUE);

-- ------------------------------------------------------------
-- 7. COMISSAO DE BORDO (funcionários)
-- ------------------------------------------------------------
INSERT INTO Comissao_De_Bordo (cpf, nome_completo, data_admissao, salario_base) VALUES
('12345678901', 'Carlos Eduardo Mota',     '2015-03-10', 18000.00),  -- Piloto
('23456789012', 'Fernanda Lima Souza',     '2017-07-01', 18500.00),  -- Piloto
('34567890123', 'Rafael Batista Nunes',    '2016-11-20', 16000.00),  -- Piloto
('45678901234', 'Juliana Martins Costa',   '2019-04-15',  8500.00),  -- Comissária
('56789012345', 'Lucas Pereira Alves',     '2020-09-05',  8200.00),  -- Comissário
('67890123456', 'Amanda Torres Leal',      '2018-01-22',  8800.00),  -- Comissária
('78901234567', 'Bruno Rodrigues Silva',   '2021-06-30',  8100.00),  -- Comissário
('89012345678', 'Patrícia Nascimento Lima','2014-08-12',  9000.00),  -- Comissária
('90123456789', 'Marcos Vinícius Araujo',  '2022-02-14',  8300.00),  -- Comissário
('01234567890', 'Cláudia Regina Ferreira', '2013-05-03', 19000.00);  -- Piloto
...
-- 13. PASSAGEIROS
-- ------------------------------------------------------------
INSERT INTO Passageiro (nome_completo, data_nascimento, nacionalidade, documento_identidade, contato_emergencia, necessidades_especiais) VALUES
('Ana Carolina Ferreira',    '1990-05-14', 'Brasileira',    'CPF-11122233344', '85999001122', FALSE),
('João Victor Oliveira',     '1985-11-30', 'Brasileira',    'CPF-22233344455', '85999003344', FALSE),
('Mariana Beatriz Santos',   '1995-03-22', 'Brasileira',    'CPF-33344455566', '85988001122', TRUE),
('Pedro Henrique Costa',     '1978-08-01', 'Brasileira',    'CPF-44455566677', NULL,          FALSE),
('Luciana Prado Mendes',     '2001-12-10', 'Brasileira',    'CPF-55566677788', '11977001122', FALSE),
('Robert Johnson',           '1970-07-04', 'Americana',     'PASSPORT-US001',  NULL,          FALSE),
('Sophie Leclerc',           '1988-02-19', 'Francesa',      'PASSPORT-FR001',  NULL,          FALSE),
('Carlos Gutiérrez',         '1982-09-09', 'Argentina',     'DNI-AR001234',    NULL,          FALSE),
('Beatriz Alves Lima',       '1993-06-25', 'Brasileira',    'CPF-66677788899', '11988003344', FALSE),
('Felipe Martins Borges',    '2000-01-17', 'Brasileira',    'CPF-77788899900', '21977001122', TRUE),
('Carla Mendonça Pires',     '1975-04-03', 'Brasileira',    'CPF-88899900011', NULL,          FALSE),
('Gustavo Henrique Ribeiro', '1998-10-21', 'Brasileira',    'CPF-99900011122', '85988004455', FALSE);
...
-- 15. PASSAGENS
-- ------------------------------------------------------------
INSERT INTO Passagem (classe_cabine, assento_passageiro, id_passageiro, codigo_localizador, bagagem_despachada, peso_bagagem) VALUES
('Econômica',      '22A', 1, 'RES-GRU-001', TRUE,  23.00),
('Econômica',      '22B', 2, 'RES-GRU-001', FALSE, NULL),
('Econômica',      '15C', 3, 'RES-GRU-002', TRUE,  20.50),
('Executiva',      '3A',  4, 'RES-GRU-003', TRUE,  32.00),
('Econômica',      '30D', 5, 'RES-GRU-004', FALSE, NULL),
('Econômica',      '10B', 6, 'RES-GRU-005', TRUE,  18.00),
('Primeira Classe','1A',  7, 'RES-GRU-006', TRUE,  28.00),
('Executiva',      '5C',  8, 'RES-GRU-007', TRUE,  25.00),
('Econômica',      '18E', 9, 'RES-GRU-008', FALSE, NULL),
('Econômica',      '25F',10, 'RES-GRU-009', TRUE,  15.00),
('Econômica',      '12A',11, 'RES-GRU-010', TRUE,  22.00),
('Executiva',      '4B', 12, 'RES-GRU-010', TRUE,  30.00);
